...
const OfferSection = ({ imageSrc, tagText, title, description, buttonText, onButtonClick }) => {
  return (
    <div className="md:p-[100px] md:pb-0 flex flex-col justify-center items-center">
      <img
        className="object-cover w-full h-398px md:h-[860px] md:max-h-[860px]"
        src={imageSrc}
        alt=""
      />
      <div className="md:mt-[60px] md:w-[1012px]">
      ...
      <Button buttonText={buttonText} onClick={onButtonClick} className="mt-[50px] w-fit" />
    </div>
  );
};
